...
begin
  ...
  arch.LoadFromFile('C:\Users\Gonzalo\Desktop\Algoritmos\2024\Ejercicios de la guia\Pascal\TratamientoArchivos\Archivos\empleados.csv'); //asigno mi archivo de entrada
  inicializar(); 
  ...
  begin
    ...
    reg.cantidad_empleados:= StrToInt(arch.cells[2,i]);
